        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/" className="text-slate-400 hover:text-brand-400 transition-smooth flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-500 group-hover:w-2 group-hover:h-2 transition-all"></span>
                    Home
                  </Link>
                </li>
                <li>
                  <Link to="/pricing" className="text-slate-400 hover:text-brand-400 transition-smooth flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-500 group-hover:w-2 group-hover:h-2 transition-all"></span>
                    Pricing
                  </Link>
                </li>
                <li>
                  <Link to="/testimonials" className="text-slate-400 hover:text-brand-400 transition-smooth flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-500 group-hover:w-2 group-hover:h-2 transition-all"></span>
                    Testimonials
                  </Link>
                </li>
                <li>
                  <Link to="/faq" className="text-slate-400 hover:text-brand-400 transition-smooth flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-500 group-hover:w-2 group-hover:h-2 transition-all"></span>
                    FAQ
                  </Link>
                </li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/about" className="text-slate-400 hover:text-brand-400 transition-smooth flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-500 group-hover:w-2 group-hover:h-2 transition-all"></span>
                    About
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="text-slate-400 hover:text-brand-400 transition-smooth flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-500 group-hover:w-2 group-hover:h-2 transition-all"></span>
                    Contact
                  </Link>
                </li>
                <li>
                  <a href="#" className="text-slate-400 hover:text-brand-400 transition-smooth flex items-center gap-2 group">
                    <span className="w-1.5 h-1.5 rounded-full bg-brand-500 group-hover:w-2 group-hover:h-2 transition-all"></span>
                    Careers
                  </a>
                </li>
          ...
          <div className="border-t border-slate-800 pt-8 md:flex md:justify-between md:items-center text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-end space-x-6">
              ...
              <a href="#" className="text-slate-400 hover:text-brand-400 transition-smooth hover:scale-110 transform" aria-label="LinkedIn">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                </svg>
              </a>
              <a href="#" className="text-slate-400 hover:text-brand-400 transition-smooth hover:scale-110 transform" aria-label="GitHub">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
