  ...
  return (
    <Card className="h-full shadow-md border-[#0077B5]/20">
      <CardContent className="pt-6">
        <h2 className="text-lg font-semibold mb-4 text-gray-800">LinkedIn Best Practices</h2>
        <div className="grid gap-3">
          {tips.map((tip, index) => (
            <div key={index} className="flex items-start gap-3 group hover:bg-gray-50 p-2 rounded-md transition-colors">
              <div className="mt-0.5 group-hover:scale-110 transition-transform">{tip.icon}</div>
              <div>
