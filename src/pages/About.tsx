  ...
  return (
    <Layout>
      <div className="py-16 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="absolute -top-[500px] -right-[500px] w-[800px] h-[800px] bg-sky-500/5 rounded-full blur-3xl animate-float pointer-events-none"></div>
        <div className="absolute -bottom-[300px] -left-[300px] w-[500px] h-[500px] bg-sky-500/5 rounded-full blur-3xl animate-float pointer-events-none" style={{ animationDelay: '2s' }}></div>
        ...
        <div className="container px-4 mx-auto relative z-10">
          ...
          <div ref={(el) => sectionRefs.current[0] = el} className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 relative">
              ...
              <div className="absolute -top-8 -right-8 text-7xl text-sky-400/10 animate-pulse">✨</div>
            </h1>
          ...
          <div ref={(el) => sectionRefs.current[2] = el} className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-sky-500/50 transition-all duration-300 hover:-translate-y-2">
                <img 
                ...
                <p className="text-sky-400 mb-2">Founder & CEO</p>
              ...
              <div className="text-center bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-sky-500/50 transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-sky-400 mb-2">CTO</p>
                <p className="text-slate-300 text-sm max-w-xs mx-auto">
              ...
              <div className="text-center bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-sky-500/50 transition-all duration-300 hover:-translate-y-2">
                ...
                <p className="text-sky-400 mb-2">Head of Product</p>
                <p className="text-slate-300 text-sm max-w-xs mx-auto">
          ...
          <div ref={(el) => sectionRefs.current[3] = el} className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-sky-500/50 transition-all duration-300 hover:-translate-y-2">
