    ...
    <Layout>
      <div className="py-16 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 relative overflow-hidden">
        ...
        <div className="container px-4 mx-auto relative z-10">
          ...
          {/* Call to Action */}
          <div ref={(el) => sectionRefs.current[4] = el} className="text-center bg-white dark:bg-slate-800 rounded-2xl p-10 max-w-4xl mx-auto border border-slate-200 dark:border-slate-700 shadow-lg">
