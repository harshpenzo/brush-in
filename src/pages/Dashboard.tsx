...
import { Trash2, Edit, Copy, Calendar, BarChart3 } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <Tabs defaultValue="posts" className="w-full">
              <TabsList className="mb-8 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-1">
                <TabsTrigger value="posts" className="data-[state=active]:bg-sky-500 data-[state=active]:text-white">
                  My Posts
                </TabsTrigger>
                ...
                <Card className="bg-white dark:bg-slate-800 shadow-sm hover:shadow-md transition-shadow border border-slate-200 dark:border-slate-700">
                  <CardContent className="p-10 flex flex-col items-center justify-center">
                    <div className="text-center">
                      <h3 className="text-xl font-medium text-slate-900 dark:text-white mb-2">Analytics Coming Soon</h3>
                      <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto">
                        We're working on building powerful analytics to help you track the performance of your LinkedIn posts.
                      </p>
                    </div>
                  </CardContent>
                </Card>
